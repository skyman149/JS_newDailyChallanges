...
iqTest("2 4 7 8 10") => 3 // Third number is odd, while the rest of the numbers are 
even

iqTest("1 2 1 1") => 2 // Second number is even, while the rest of the numbers are
 odd
*/
...
function iqTest(numbers){
    ...
    let even = numArr.filter(el => el % 2 === 0);
    let odd = numArr.filter(el => el % 2 !== 0);
